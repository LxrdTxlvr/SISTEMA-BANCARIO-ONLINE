        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <select 
              ...
              className="w-full px-4 py-3 rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              required
          ...
          <div className="flex gap-4">
            ...
            >
              {loading ? <Loader2 className="animate-spin mx-auto" /> : 'Confirmar Depósito'}
            </button>
          </div>
        </form>
      </div>
